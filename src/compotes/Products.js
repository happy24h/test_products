...
import SortSelect from "./product/SortSelect";
        ...
        <div className="container-fluid" data-aos="fade-in">
          ...
          <div className="d-flex justify-content-between items-center pt-5 pb-4 flex-column flex-lg-row">
            <div>
              ...
              <nav aria-label="breadcrumb">
                ...
                {/* <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item"><a href="#">Sneakers</a></li>
            ...
            <div className="d-flex justify-content-end align-items-center mt-4 mt-lg-0 flex-column flex-md-row">
              ...
              {/* <select  id="sort" value={sort} onChange={handleSortChange} className="form-select form-select-sm border-0 bg-light p-3 pe-5 lh-1 fs-7 bg-light p-3 me-md-3 d-flex align-items-center fs-7 lh-1 w-100 mb-2 mb-md-0 w-md-auto ">
