...
const Product = () => {
    ...
    const handleCart = (product, redirect) => {
        ...
        if (redirect) {
            navigate("/cart");
            toast.success("Add to cart succuses ");
        }
    };
    const Loading = () => {
        return (
                ...
                <div className="col-12 col-md-6 col-lg-5">
                    <div className="sticky-top top-5">
                        <div className="pb-3" data-aos="fade-in">
                            ...
                            <h1 className="mb-1 fs-2 fw-bold">{product.category.name}</h1>
                ...
                <div className="container-fluid mt-5">
                    ...
                    <div className="row g-0">
                        ...
                        <div className="col-12" data-aos="fade-up">
                            <h3 className="fs-4 fw-bolder mt-7 mb-4">
                                You May Also Like
                            </h3>
                            {/* <!-- Swiper Latest --> */}
                        ...
                        {/* <!-- Reviews--> */}
                        <div className="col-12" data-aos="fade-up">
                            <h3 className="fs-4 fw-bolder mt-7 mb-4 reviews">
                                Reviews
                            </h3>
                            ...
                            <div className="bg-light p-5 justify-content-between d-flex flex-column flex-lg-row">
                                ...
                                <div className="d-flex flex-grow-1 flex-column ms-lg-8">
                                    ...
                                    <p className="mt-3 mb-0 d-flex align-items-start">
                                        <i className="ri-chat-voice-line me-2"></i>{" "}
                            ...
                            <div className="row g-6 g-md-8 g-lg-10 my-3">
                                <div className="col-12 col-lg-6 col-xxl-4">
                                    ...
                                    <p className="fs-7">
                                        Worth buying this for value for money.
                                        But be warned: get one size larger as
                                        the medium is closer to small medium!
                                    </p>
                                </div>
                                <div className="col-12 col-lg-6 col-xxl-4">
                                    <div className="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <p className="fs-7">
                                        Loose and poor stiching on the sides.
                                ...
                                <div className="col-12 col-lg-6 col-xxl-4">
                                    ...
                                    <p className="fs-7">
                                        I buy these often as they are good
                                ...
                                <div className="col-12 col-lg-6 col-xxl-4">
                                    ...
                                    <p className="fs-7">
                                        Wore this to my local music festival -
                                        went down well.
                                    </p>
                                </div>
                                <div className="col-12 col-lg-6 col-xxl-4">
                                    ...
                                    <p className="fs-7">
                                        Bought this on the off chance it would
                                        work well with my skinny jeans, was a
                                        great decision. Would recommend.
                                    </p>
                                </div>
                                <div className="col-12 col-lg-6 col-xxl-4">
                                    <div className="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <p className="fs-7">
                                        It&#x27;s a t-shirt. What can I say, it
                                        does the job.
                                    </p>
                                </div>
                            </div>
