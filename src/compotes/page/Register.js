    ...
    return (
       ...
       className="mt-0 overflow-hidden  vh-100 d-flex justify-content-center align-items-center p-4">
        ...
        <div className="col col-md-8 col-lg-6 col-xxl-5">
            {/* <!-- Logo--> */}
            <NavLink className="navbar-brand fw-bold fs-3 flex-shrink-0 order-0 align-self-center justify-content-center d-flex mx-0 px-0" to="./index.html">
            ...
            <div className="shadow-xl p-4 p-lg-5 bg-white">
                ...
                <form>
                  ...
                  <p className="d-block text-center text-muted">Already registered? <NavLink className="text-muted" to="/login">Login here.</NavLink></p>
            </div>
