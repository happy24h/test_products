        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12h-15" />
              ...
              {/* <div className="row">
                        <div className="row main align-items-center">
                            ...
                            <div className="col">
                                <NavLink to="#">-</NavLink><NavLink to="#" className="border">1</NavLink><NavLink to="#">+</NavLink>
                            </div>
            ...
            <div className="col-md-4 summary">
              ...
              <hr />
              <div className="row">
                <div className="col pl-0">ITEMS { carts.length}</div>
              ...
              >
                ...
                <div className="col text-right">$ {(total + 100).toFixed(2)}</div>
              </div>
